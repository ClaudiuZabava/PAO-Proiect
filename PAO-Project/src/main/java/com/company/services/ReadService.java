...
//                if (tokens.length > 0) {
//                    //Create a new student object and fill his  data
//                    Sala info = new Sala(Integer.parseInt(tokens[0]), Integer.parseInt(tokens[2]), tokens[1]);
//                    infos.add(info);
//                }
//            }
            infos = dbm.getAllRooms();
            if( infos.size()>=1)
            {
                return infos;
            }
...
//                System.out.println("Read materie 2");
    ...
    public int readCsvProfesor(String fileName)
    {
        ...
        String path2 = "src/main/java/com/company/date/contacte.csv";
        File file2 = new File(path2);
        String absolutePath2 = file2.getAbsolutePath();
        String path3 = "src/main/java/com/company/date/adrese.csv";
...
//            }
    ...
    public int readCsvCatalog(String fileName)
    {
        ...
        BufferedReader fileReader = null;
        String path2 = "src/main/java/com/company/date/studenti.csv";
        File file2 = new File(path2);
        String absolutePath2 = file2.getAbsolutePath();
        String path3 = "src/main/java/com/company/date/profesori.csv";
        File file3 = new File(path3);
        String absolutePath3 = file3.getAbsolutePath();
