...
public class AppService
{
    ...
    Adresa citeste_adresa(){
        ...
        int id;
        int content;
        String path1 = "src/main/java/com/company/date/adrese.csv";
        File file1 = new File(path1);
        String fileName = file1.getAbsolutePath();

        content = dbm.getSize("adresa");
        if(content == 0)
        {
            id = 1;
        }
        ...
        String path = "src/main/java/com/company/date/adrese.csv";
        File file = new File(path);
        String absolutePath = file.getAbsolutePath();

        write_service.writeCsvAdresa(absolutePath, adresa);

        String path2 = "src/main/java/com/company/date/auditIn.csv";
    ...
    Contact citeste_contact(){
        ...
        int id;
        int content;
        String path1 = "src/main/java/com/company/date/contacte.csv";
        File file1 = new File(path1);
        String fileName = file1.getAbsolutePath();

        content = dbm.getSize("contact");
        if(content == 0)
        {
            id = 1;
        }
        ...
        String path = "src/main/java/com/company/date/contacte.csv";
        File file = new File(path);
        String absolutePath = file.getAbsolutePath();
    ...
    Sala citeste_sala()
    {
        ...
        int id;
        int content;
        String path1 = "src/main/java/com/company/date/sali.csv";
        File file1 = new File(path1);
        String fileName = file1.getAbsolutePath();

        content = dbm.getSize("sala");
        if(content == 0)
        {
            id = 1;
        }
        ...
        System.out.println("Id linie sala: " + id);
        sl.set_Id(id);
        ...
        String path = "src/main/java/com/company/date/sali.csv";
        File file = new File(path);
        String absolutePath = file.getAbsolutePath();
    ...
    Materie citeste_materie(){
        ...
        int id;
        int content;
        String path1 = "src/main/java/com/company/date/materii.csv";
        File file1 = new File(path1);
        String fileName = file1.getAbsolutePath();

        content = dbm.getSize("materie");
        if(content == 0)
        {
            id = 1;
        }
        ...
        String path = "src/main/java/com/company/date/materii.csv";
        File file = new File(path);
        String absolutePath = file.getAbsolutePath();
    ...
    Profesor citire_profesor(){
        ...
        int id;
        int content;
        String path1 = "src/main/java/com/company/date/profesori.csv";
        File file1 = new File(path1);
        String fileName = file1.getAbsolutePath();

        content = dbm.getSize("profesor");
        if(content == 0)
        {
            id = 1;
        }
        ...
        String path = "src/main/java/com/company/date/profesori.csv";
        File file = new File(path);
        String absolutePath = file.getAbsolutePath();
    ...
    Student citire_student(){
        ...
        int id;
        int content=0;
        String path1 = "src/main/java/com/company/date/studenti.csv";
        File file1 = new File(path1);
        String fileName = file1.getAbsolutePath();

        content = dbm.getSize("student");
        if(content == 0)
        {
            id = 1;
        }
        ...
        String path = "src/main/java/com/company/date/studenti.csv";
        File file = new File(path);
        String absolutePath = file.getAbsolutePath();
    ...
    Catalog citire_catalog() throws ParseException {
        ...
        int id;
        int content;
        String path1 = "src/main/java/com/company/date/fileCatalog.csv";
        File file1 = new File(path1);
        String fileName = file1.getAbsolutePath();

        content = dbm.getSize("fila_catalog");
        if(content == 0)
        {
            id = 1;
        }
        ...
        String path = "src/main/java/com/company/date/fileCatalog.csv";
        File file = new File(path);
        String absolutePath = file.getAbsolutePath();
