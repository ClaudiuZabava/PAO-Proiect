...
public class WriteService {
    ...
    private static final String FILE_HEADER3 = "id, codSala, etaj";
    ...
    public static void writeCsvAdresa(String fileName, Adresa adresa) {
        ...
        try {
            ...
            fileWriter.append(NEW_LINE_SEPARATOR);
            System.out.println("Adresa salvata in fisierul CSV si DB!!!");

            dbm.insertAdresa(adresa);
        }
        catch (Exception e)
        {
    ...
    public static void writeCsvContact(String fileName, Contact info) {
        ...
        try {
            ...
            fileWriter.append(NEW_LINE_SEPARATOR);
            System.out.println("Contact salvat in fisierul CSV si in DB!!!");

            dbm.insertContact(info);
        }
        catch (Exception e)
        {
            System.out.println("Eroare la incarcarea datelor in CSV !!!");
    ...
    public static void writeCsvSala(String fileName, Sala sala) {
        ...
        try {
            ...
            //Write a new student object list to the CSV file
            fileWriter.append(String.valueOf(sala.get_Id()));
            fileWriter.append(COMMA_DELIMITER);
            fileWriter.append(String.valueOf(sala.get_Cod()));
            fileWriter.append(COMMA_DELIMITER);
            fileWriter.append(String.valueOf(sala.get_Etaj()));
            fileWriter.append(NEW_LINE_SEPARATOR);
            System.out.println("Sala salvat in fisierul CSV si in DB!!!");
    ...
    public static void writeCsvMaterie(String fileName, Materie materie) {
        ...
        try {
            ...
            fileWriter.append(NEW_LINE_SEPARATOR);
            System.out.println("Materie salvat in fisierul CSV si DB!!!");

            dbm.insertMaterie(materie);
    ...
    public static void writeCsvProfesor(String fileName, Profesor prof) {
        ...
        try {
            ...
            fileWriter.append(NEW_LINE_SEPARATOR);
            System.out.println("Profesor salvata in fisierul CSV si in DB!!!");

            dbm.insertProfesor(prof);
        }
        catch (Exception e)
        {
            System.out.println("Eroare la incarcarea datelor in CSV !!!");
    ...
    public static void writeCsvStudent(String fileName, Student student) {
        ...
        try {
            ...
            fileWriter.append(NEW_LINE_SEPARATOR);
            System.out.println("Student salvata in fisierul CSV si in DB!!!");

            dbm.insertStudent(student);
        }
        catch (Exception e)
        {
            System.out.println("Eroare la incarcarea datelor in CSV !!!");
    ...
    public static void writeCsvCatalog(String fileName, Catalog catalog) {
        ...
        try {
            ...
            while (it.hasNext())
            {
                int itt = it.next().get_Id();
                fileWriter.append(COMMA_DELIMITER);
                fileWriter.append(String.valueOf(itt));

                dbm.insertCatalog(catalog,itt);
